...
//        int item = bundle.getInt("ExamListDataItem",0);
        datas = SubjectTestDataDao.getInstance(this).getSubjects(TestMode.MODE_PRACTICE, 1211);
    ...
    public void onClick(View view) throws IOException {
        switch (view.getId()) {
            ...
            case R.id.btnDone:
                ...
                UploadResultsManager.getSingleton(this).uploadResult(PreferenceHelper.getInstance(this).getIntValue(PreferenceHelper.USER_ID), 1211);
