...
import com.edu.subject.common.AutoSplitTextView;
import com.edu.subject.common.PicBrowseAdapter;
...
public class PicBrowseView extends RelativeLayout implements OnPageChangeListener, OnClickListener {
	...
	private void initPages() {
		...
		if(mQuestion != null && !mQuestion.equals("")) {
			com.edu.subject.common.AutoSplitTextView textView = (AutoSplitTextView) View.inflate(mContext, R.layout.view_bill_question, null);
