 ...
 * @author lucher
 */
public class ErrorSubjectSingleSelectView extends ErrorBaseScrollView implements OnClickListener, ISubject {
    ...
    public ErrorSubjectSingleSelectView(Context context, BaseTestData data, int testMode) {
