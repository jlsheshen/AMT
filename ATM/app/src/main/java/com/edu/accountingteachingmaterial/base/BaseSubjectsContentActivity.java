 ...
 * 
 */
public abstract class BaseSubjectsContentActivity extends FragmentActivity implements OnItemClickListener, SubjectListener, SubjectCardAdapter.OnCardItemClickListener, OnPageChangeListener, CountryTestTimer.OnTimeOutListener {
	...
	//计时器
	protected CountryTestTimer mTimer;
