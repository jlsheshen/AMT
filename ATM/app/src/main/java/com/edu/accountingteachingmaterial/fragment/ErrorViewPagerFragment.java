...
import com.edu.accountingteachingmaterial.subject.view.ErrorSubjectJudgeView;
import com.edu.accountingteachingmaterial.subject.view.ErrorSubjectMultiSelectView;
import com.edu.accountingteachingmaterial.subject.view.ErrorSubjectSingleSelectView;
 ...
 * @author lucher
 */
public class ErrorViewPagerFragment extends Fragment {
     ...
     * @return
     */
    public static ErrorViewPagerFragment newInstance(BaseTestData data, SubjectListener listener) {
        ErrorViewPagerFragment fragment = new ErrorViewPagerFragment();
        fragment.mData = data;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        switch (mData.getSubjectType()) {
            ...
            case SubjectType.SUBJECT_SINGLE:
                ...
                mView = new ErrorSubjectSingleSelectView(mContext, mData, testMode);
                break;
            case SubjectType.SUBJECT_JUDGE:
                mView = new ErrorSubjectJudgeView(mContext, mData,testMode);
                break;
            case SubjectType.SUBJECT_MULTI:
                mView = new ErrorSubjectMultiSelectView(mContext, mData,testMode);
                break;
