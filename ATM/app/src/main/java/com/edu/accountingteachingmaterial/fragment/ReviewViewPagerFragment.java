...
import com.edu.accountingteachingmaterial.subject.view.ReviewSubjectMultiSelectView;
import com.edu.accountingteachingmaterial.subject.view.ReviewSubjectSingleSelectView;
import com.edu.accountingteachingmaterial.subject.view.ReviewrSubjectJudgeView;
 ...
 * @author lucher
 */
public class ReviewViewPagerFragment extends Fragment {
     ...
     * @return
     */
    public static ReviewViewPagerFragment newInstance(BaseTestData data, SubjectListener listener) {
        ReviewViewPagerFragment fragment = new ReviewViewPagerFragment();
        fragment.mData = data;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        switch (mData.getSubjectType()) {
            ...
            case SubjectType.SUBJECT_SINGLE:
                ...
                mView = new ReviewSubjectSingleSelectView(mContext, mData, testMode);
                break;
            case SubjectType.SUBJECT_JUDGE:
                mView = new ReviewrSubjectJudgeView(mContext, mData,testMode);
                break;
            case SubjectType.SUBJECT_MULTI:
                mView = new ReviewSubjectMultiSelectView(mContext, mData,testMode);
                break;
