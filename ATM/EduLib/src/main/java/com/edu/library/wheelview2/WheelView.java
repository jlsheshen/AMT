...
public class WheelView extends View {
	...
	/** Items text color */
	private int ITEMS_TEXT_COLOR = -6710887;
	...
	public void setItemsPaint(TextPaint itemsPaint) {
		this.itemsPaint = itemsPaint;
	}
	...
	public void setValuePaint(TextPaint valuePaint) {
	...
	private void initResourcesIfNecessary() {
		...
		// setBackgroundResource(R.drawable.dialog_wheel_bg);
	}
	...
	private void drawValue(Canvas canvas) {
		...
		valuePaint.setTextSize(CURRENT_TEXT_SIZE);
